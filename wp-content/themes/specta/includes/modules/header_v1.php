<?php 
$options = _WSH()->option();
$about_logo = specta_set( $options, 'about_logo_image' );
            ...
            <div class="outer-container clearfix">
                <div class="pull-left logo-outer">
                    <div class="logo">
                        ...
                        <?php else: ?>
                            <a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_url( get_template_directory_uri().'/images/logo.svg' ); ?>" alt="<?php esc_attr_e( 'Specta', 'specta' ); ?>"></a>
                        <?php endif; ?>
                ...
                <div class="pull-right upper-right clearfix">
                    ...
                    <div class="nav-outer clearfix">
                        ...
                        <div class="outer-box nav-toggler">
                           ...
                           <?php if( specta_set($options, 'show_sidebar') ):?>
...
<section class="hidden-bar right-align">
    ...
    <div class="hidden-bar-wrapper">
        ...
        <div class="content-box">
            ...
            <h2><?php echo wp_kses_post( specta_set( $options, 'about_title' ) ); ?></h2>
            
            <div class="text"><?php echo wp_kses_post( specta_set( $options, 'about_text' ) ); ?></div>
            
            <?php if ( specta_set( $options, 'about_btn_title' ) ) :  ?>
                <a href="<?php echo esc_url( specta_set( $options, 'about_btn_link' ) ); ?>" class="theme-btn btn-style-two"><?php echo wp_kses_post( specta_set( $options, 'about_btn_title' ) ); ?></a>
            <?php endif; ?>
            
        </div>
        
        <div class="contact-info">
            <h2><?php echo wp_kses_post( specta_set( $options, 'about_info_title' ) ); ?></h2>
