...
<!--Gallery Item Four-->
<div class="gallery-item-four mix all <?php echo esc_attr( $term_slug ); ?> col-lg-3 col-md-4 col-sm-6 col-xs-12">
    <div class="inner-box">
        <div class="image">
            <?php the_post_thumbnail( 'specta_270x175', array( 'class' => 'img-responsive' ) ); ?>
...
<section class="gallery-mixitup-section load-more-gallery">
    <div class="auto-container">
        <!--MixitUp Galery-->
        <div class="mixitup-gallery load-more-gallery-one">
