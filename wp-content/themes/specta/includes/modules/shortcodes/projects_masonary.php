            ...
            <?php 
				while( $query->have_posts() ) : $query->the_post();
                 ...
                 if( specta_set( $projects_meta, 'extra_width' ) == 'extra_width' && specta_set( $projects_meta, 'extra_height' ) == 'extra_height' ) { 
					$image_size = 'specta_676x653';
                    $class ="col-md-7 col-sm-12 col-xs-12";
				 } elseif( specta_set($projects_meta, 'extra_width') == 'normal_width' ) {
					$image_size = 'specta_474x311';
                    $class ="col-md-5 col-sm-6 col-xs-12";
				 } elseif( specta_set( $projects_meta, 'extra_width' ) == 'extra_width' ) {
					$image_size = 'specta_575x311';
