...
//Services
specta_vc_map( array(
			"name" => esc_html__("bbPress Forums", 'specta'),
			"base" => "bbp-forum-index",
			"class" => "",
			"category" => esc_html__('Jollyall', 'specta'),
			"icon" => 'faqs' ,
			"params" => array(				
				array(
				   "type" => "textfield",
				   "holder" => "div",
				   "class" => "",
				   "heading" => esc_html__("Forum", 'specta'),
				   "param_name" => "forum",
				   "description" => ''
				),
...
$param = array(
  ...
  "holder" => "div",
  "class" => "",
  "heading" => esc_html__("Container", 'specta'),
  "param_name" => "container",
  "value" => array('Center Page'=>true),
  "description" => esc_html__("Choose whether you want to add a container before row or not.", 'specta')
);
