...
if( !$layout || $layout == 'full' || specta_set($_GET, 'layout_style')=='full' ) $classes[] = 'shop-item col-md-3 col-sm-6 col-xs-12'; else $classes[] = 'shop-item col-lg-4 col-md-6 col-sm-6 col-xs-12';
//$pro_num = specta_set($options, 'number_of_product_column');
