...
$options[] = array(
	'id'          => '_bunch_header_portfolio_settings',
...
$options[] =  array(
	...
	'template'    => array(
        array(
            ...
            'label' => __( 'Select Portfolio Detail Page Style', BUNCH_NAME ),
            'default' => 'style_one',
            'items' => array(
                array(
                    'value' => 'style_one',
                    'label' => __( 'Style One', BUNCH_NAME ),
                ),
                array(
                    'value' => 'style_two',
                    'label' => __( 'Style Two', BUNCH_NAME ),
                ),
                array(
                    'value' => 'style_three',
                    'label' => __( 'Style Three', BUNCH_NAME ),
                ),
                array(
                    'value' => 'style_four',
                    'label' => __( 'Style Four', BUNCH_NAME ),
                ),
            ),
        ),
        array(
            'type' => 'textbox',
            'name' => 'delay_time',
            'label' => __('Data Delay Time', BUNCH_NAME),
            'default' => '',
        ),
        array(
            'type' => 'textbox',
        ...
        array(
            ...
            'repeating' => true,
            'length'    => 1,
            'name'      => 'bunch_portfolio_gallery',
            'title'     => __('Gallery', BUNCH_NAME),
            'fields'    => array(
                array(
                    'type' => 'upload',
                    'name' => 'gallary_img',
        ...
        array(
            ...
            'repeating' => true,
            'length'    => 1,
            'name'      => 'bunch_portfolio_gallery1',
            'title'     => __('Gallery Two(shown only on portfolio style one)', BUNCH_NAME),
            'fields'    => array(
                array(
                    'type' => 'upload',
                    'name' => 'gallary_img',
